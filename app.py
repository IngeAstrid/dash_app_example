...
app.layout = html.Div([
    ...
    html.Div('by Zhou Yizhe, Section B', style={'color': 'rgb(10, 186, 181)', 'fontSize': 24})
])
...
def update_graph(xaxis_column_name, yaxis_column_name,
    ...
    return {  #still in call back function
        'data': [go.Scatter(
            x=dff[(dff['NA_item'] == xaxis_column_name)&(dff['Unit'] == i)]['Value'],
            y=dff[(dff['NA_item'] == yaxis_column_name)&(dff['Unit'] == i)]['Value'],
            text=dff[(dff['NA_item'] == yaxis_column_name)&(dff['Unit'] == i)]['Geo'],
            mode='markers',
            marker={
                'size': 15,
                'opacity': 0.5,
...
def update_graph(xaxis_column_name, yaxis_column_name,
    ...
    return {  #still in call back function
        'data': [go.Scatter(
            x=df['Time'].unique(),
            y=df[(df['Geo'] == xaxis_column_name) & (df['NA_item'] == yaxis_column_name)&(df['Unit'] == i)]['Value'],
